...
public class ResultParserParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("ResultParser");
  ...
  { 
    ResultParserParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    ...
    { 
      ...
      descriptor.setAttachmentProvider(ResultParserParseControllerGenerated.class);
    }
  ...
  { 
    return ResultParserParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
